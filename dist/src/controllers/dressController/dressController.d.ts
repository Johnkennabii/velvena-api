...
export declare const softDeleteDress: (req: AuthenticatedRequest, res: Response) => Promise<void>;
export declare const hardDeleteDress: (req: AuthenticatedRequest, res: Response) => Promise<void>;
