...
export const createServiceType = async (req, res) => {
    try {
        ...
        logger.info({ serviceTypeId: serviceType.id, organizationId: req.user.organizationId }, "Service type created");
        res.status(201).json({
            success: true,
            data: serviceType,
        });
...
export const updateServiceType = async (req, res) => {
    try {
        ...
        logger.info({ serviceTypeId: serviceType.id, organizationId: req.user.organizationId }, "Service type updated");
        res.json({
            success: true,
            data: serviceType,
        });
...
export const deleteServiceType = async (req, res) => {
    try {
        ...
        logger.info({ serviceTypeId: id, organizationId: req.user.organizationId }, "Service type deleted");
        res.json({
            success: true,
