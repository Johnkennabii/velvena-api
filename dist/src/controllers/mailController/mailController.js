import { getEmails, getEmailByUid, deleteEmail, permanentlyDeleteEmail, markAsRead, markAsUnread, getMailboxes, sendEmail, addFlag, removeFlag, moveEmail, getEmailAttachment, listMailFolders, createMailFolder, moveMailFolder, } from "../../lib/mailService.js";
 ...
 */
export async function moveMailFolderController(req, res) {
    try {
 ...
 */
export async function downloadAttachmentByEmailId(req, res) {
    try {
        const { emailId, index: indexParam } = req.params;
        const mailboxQuery = req.query.mailbox || "inbox";
