 ...
 */
export function getEffectiveOrganizationId(req) {
 ...
 */
export function requireOrganizationContext(req, res) {
 ...
 */
export function isSuperAdminContext(req) {
    return req.organizationContext?.isSuperAdminContext ?? false;
}
//# sourceMappingURL=organizationHelper.js.map