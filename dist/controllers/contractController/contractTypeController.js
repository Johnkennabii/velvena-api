...
export const getContractTypes = async (_req, res) => {
    try {
...
// SOFT DELETE
export const softDeleteContractType = async (req, res) => {
    try {
        const { id } = req.params;
        if (!id) {
            return res.status(400).json({ success: false, error: "ID is required" });
...
// HARD DELETE
export const hardDeleteContractType = async (req, res) => {
    try {
        const { id } = req.params;
        if (!id) {
            return res.status(400).json({ success: false, error: "ID is required" });
...
//# sourceMappingURL=contractTypeController.js.map