// src/controllers/customerNoteController.ts
...
export const getCustomerNotes = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
// Get one note by ID
export const getCustomerNoteById = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    if (!id) {
...
export const createCustomerNote = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { customerId } = req.params;
...
// Update a note
export const updateCustomerNote = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    const { content } = req.body;
...
// Soft delete a note
export const softDeleteCustomerNote = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    if (!id) {
      return res.status(400).json({ success: false, error: "Note ID is required" });
...
// Hard delete a note
export const hardDeleteCustomerNote = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    if (!id) {
      return res.status(400).json({ success: false, error: "Note ID is required" });
