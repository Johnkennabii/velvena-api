 ...
 */
export async function replyToMail(req: Request, res: Response): Promise<void> {
  try {
    const mailboxParam = req.params.mailbox || "inbox";
    const mailboxType = normalizeMailboxType(mailboxParam);
    const uidParam = req.params.uid;
 ...
 * Body: { body: string, bodyText?: string, attachments?: [] }
 */
export async function replyAllToMail(req: Request, res: Response): Promise<void> {
  try {
    const mailboxParam = req.params.mailbox || "inbox";
    const mailboxType = normalizeMailboxType(mailboxParam);
    const uidParam = req.params.uid;
 ...
 */
export async function forwardMail(req: Request, res: Response): Promise<void> {
  try {
    const mailboxParam = req.params.mailbox || "inbox";
    const mailboxType = normalizeMailboxType(mailboxParam);
    const uidParam = req.params.uid;
